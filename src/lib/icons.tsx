...
// Order icon for order management
export const OrderIcon: React.FC<IconProps> = ({ size = 18, strokeWidth = 1.5, className, color = '#1a3a2a' }) => (
...
export const StarIcon: React.FC<IconProps> = ({ size = 18, strokeWidth = 1.5, className, color = '#1a3a2a' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
