...
const HomePage: React.FC = () => {
  ...
  headers={"Authorization": api_key}
        ...
        <style jsx>{`
          ...
          .section-header{text-align:center;margin:0 auto 40px;display:flex;flex-direction:column;align-items:center}
          .section-header h2{font-size:40px;font-weight:700;line-height:1.3;margin:0 0 20px;color:#1a1a1a}
          .section-header p{font-size:20px;color:#6b7280;line-height:1.6;margin:0;max-width:420px;text-align:center}
          ...
          .cta-section{padding:100px 24px;text-align:center;background:#f9fafb}
          ...
          @media(max-width:1024px){.hero{padding:120px 24px 60px}.hero-content,.api-grid{grid-template-columns:1fr;text-align:center}.hero-left h1{font-size:38px}.hero-left p{margin:0 auto 30px;max-width:500px}.hero-stats{justify-content:center}.mockup-wrapper{width:100%;max-width:500px;height:auto;min-height:480px;margin:0 auto}.phone{position:relative;left:auto;top:auto;width:100%;max-width:280px;margin:0 auto 20px}.code-box{position:relative;right:auto;bottom:auto;width:100%;max-width:320px;margin:0 auto}.section-header h2{font-size:32px}.section-header p{font-size:18px}.touchpoint{padding:80px 24px}.api{padding:80px 24px}.api-info h2{font-size:30px}.api-desc{font-size:18px;max-width:600px;margin:0 auto 30px}.capabilities{padding:80px 24px}.capabilities-grid{grid-template-columns:repeat(2,1fr);gap:36px 40px}.cta-section{padding:70px 24px}.cta-section h2{font-size:32px}}
          
          
        @media(max-width:767px){.hdr-in{padding:12px 16px}.logo{gap:5px}.logo-img{width:40px;height:40px}.logo-text{height:40px}.logo-main{font-size:18px}.logo-sub{font-size:10px;margin-top:2px}.hero{padding:calc(80px + env(safe-area-inset-top)) 16px 40px}.hero-content{display:flex;flex-direction:column;gap:24px}.hero-right{order:-1}.hero-left{text-align:left;order:1}.hero-left h1{font-size:28px;letter-spacing:-0.5px;margin:0 0 14px;line-height:1.15}.hero-left p{font-size:16px;line-height:1.5;margin:0 0 20px;color:#6b7280}.hero-stats{display:flex;gap:10px;justify-content:flex-start}.stat{background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:14px 12px;flex:1;min-width:0;text-align:center}.stat span{font-size:20px;font-weight:700}.stat small{font-size:11px;margin-top:4px;display:block}.mockup-wrapper{display:flex;flex-direction:column;gap:12px;width:100%;height:auto;min-height:auto;padding:16px;background:#e8f5f0;border-radius:20px}.phone{position:relative;left:auto;top:auto;width:100%;max-width:100%;margin:0;border-radius:16px}.chat-area{min-height:200px;padding:12px}.msg{font-size:14px;padding:10px 12px}.code-box{position:relative;right:auto;bottom:auto;width:100%;max-width:100%;margin:0;border-radius:12px}.code-header{padding:10px 14px}.code-body{font-size:11px;padding:14px;line-height:1.5}.section-header{padding:0;margin-bottom:32px}.section-header h2{font-size:26px;margin-bottom:14px;line-height:1.2}.section-header p{font-size:15px;max-width:100%;line-height:1.5}.touchpoint{padding:50px 16px}.usecase-pills{justify-content:flex-start;gap:10px;overflow-x:auto;-webkit-overflow-scrolling:touch;flex-wrap:nowrap;padding-bottom:10px}.pill{padding:12px 20px;font-size:13px;flex-shrink:0}.api{padding:50px 16px}.api-grid{gap:24px}.api-info{text-align:left}.api-info h2{font-size:26px;margin-bottom:14px}.api-desc{font-size:15px;line-height:1.6}.api-demo{border-radius:14px}.code-tabs{display:flex;justify-content:flex-start;gap:8px;padding:12px 14px;overflow-x:auto;-webkit-overflow-scrolling:touch;flex-wrap:nowrap}.tab{padding:10px 16px;font-size:13px;white-space:nowrap;flex-shrink:0}.code-block{font-size:11px;padding:16px;min-height:150px;overflow-x:auto;-webkit-overflow-scrolling:touch}.ftr{padding:20px 16px;padding-bottom:calc(20px + env(safe-area-inset-bottom));background:#fff}.ftr-contact{font-size:14px}.capabilities{padding:50px 16px}.capabilities .section-header{margin-bottom:36px}.capabilities-grid{grid-template-columns:1fr 1fr;gap:28px 20px}.capability-card h3{font-size:16px;margin-bottom:6px}.capability-card p{font-size:14px;line-height:1.4}.cta-section{padding:60px 16px;background:#f9fafb}.cta-section h2{font-size:26px;line-height:1.25}}
        @media(max-width:480px){.capabilities-grid{grid-template-columns:1fr;gap:28px}}`}</style>
      </div>
    </>
  );
};
