/**
 * Sustainability Page - Public landing page
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Sustainability | WECARE.DIGITAL" />
        <meta property="og:description" content="Track and offset your digital carbon footprint with every message." />
        <meta property="og:image" content={LOGO_URL} />
        <meta property="og:url" content="https://stack.wecare.digital/sustainability" />
      ...
      <div className="pg">
        ...
        <section className={`cta anim ${show('cta') ? 'show' : ''}`} id="cta">
          ...
          <p>Built into every Stack CRM plan. No extra cost.</p>
