...
/**
 * /dastavez — the Dastavez product page.
 *
 ...
 * own the route.
 *
 * ROUTING: '/dastavez' must be in the EXACT-MATCH allowlist in _app.tsx or this renders an
 * empty body with HTTP 200, and in PUBLIC_EXACT in scripts/generate-sitemap.js or it is
 * never advertised. trailingSlash means the URL is /dastavez/.
 *
 ...
 */
const DastavezPage: React.FC = () => <ProductPage product={ productBySlug( 'dastavez' ) } />;

export default DastavezPage;
