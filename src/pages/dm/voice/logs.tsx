...
export default function VoiceLogsPage({ signOut, user }: PageProps) {
  ...
  return (
    <Layout user={user} onSignOut={signOut}>
      <SEO title="Voice Logs | WECARE.DIGITAL" description="Voice call logs" />
      <div className="inner-page logs-page">
        <div className="page-header"><h2>Voice Logs</h2><Button variant="secondary" icon="refresh" iconOnly ariaLabel="Refresh" onClick={loadData} disabled={loading} loading={loading} /></div>
