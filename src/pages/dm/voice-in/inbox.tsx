          ...
          <div className="inbox-sidebar">
            ...
            <div className="contacts-list">
              ...
              {!loading && filteredContacts.length === 0 && (
                <div className="empty-contacts">No inbound call contacts</div>
              )}
            </div>
          </div>
              ...
              <>
                ...
                <div className="messages-list">
                  {filteredCalls.map(call => (
                    <div key={call.callId} className="message-card">
                      <div className="message-meta">
                        <span className="message-direction">↙ Inbound Call</span>
                  ...
                  {filteredCalls.length === 0 && (
                    <div className="empty-messages">No inbound calls from this contact</div>
                  )}
                </div>
              </>
            ) : (
