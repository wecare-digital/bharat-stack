      ...
      for (const contactId of selectedContacts) {
        ...
        try {
          const response = await fetch(`${API_BASE}/sms-aws/send`, {
            ...
            body: JSON.stringify({ contactId, content: messageContent, messageType: 'PROMOTIONAL', campaignId, campaignName })
          });
      ...
      {activeTab === 'create' && (
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <textarea value={messageContent} onChange={e => setMessageContent(e.target.value)} placeholder="Enter your SMS message..." rows={4} maxLength={160} />
          </div>
          ...
          <Button variant="primary" className="btn-block" onClick={handleSendCampaign} disabled={sending || selectedContacts.length === 0 || !messageContent.trim()} loading={sending}>
        ...
        <div className="table-container">
          <table>
            ...
            <tbody>
              ...
              {campaigns.length === 0 && (
                <tr><td colSpan={6} className="empty-state">No campaigns yet</td></tr>
              )}
            </tbody>
          </table>
        </div>
