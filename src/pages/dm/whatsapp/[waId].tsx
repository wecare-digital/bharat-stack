  ...
  return (
    <Layout user={user} onSignOut={signOut}>
      ...
      <style jsx>{`
        ...
        /* Payment messages */
        .payment-message { display: flex; align-items: center; gap: 12px; padding: 12px; background: #f0fdf4; border-radius: 8px; border-left: 3px solid #047857; }
        ...
        .button-message { display: flex; align-items: center; gap: 10px; padding: 8px 12px; background: #f0fdf4; border-radius: 8px; border-left: 3px solid #047857; }
