...
const FRONTEND_ROUTES: FrontendRoute[] = [
  ...
  // WhatsApp
  { path: '/workspace/whatsapp', label: 'WhatsApp Inbox', backend: 'messages-read, inbound-whatsapp, outbound-whatsapp', tables: 'WhatsAppInbound, WhatsAppOutbound, Contact' },
  { path: '/workspace/whatsapp/templates', label: 'WA Templates', backend: 'whatsapp-templates, whatsapp-template-management', tables: 'TemplateAnalytics' },
  { path: '/workspace/whatsapp/campaign', label: 'WA Campaign', backend: 'outbound-whatsapp, bulk-job-create', tables: 'BulkJob, BulkRecipient, WhatsAppOutbound' },
  { path: '/workspace/whatsapp/flows', label: 'WA Flows', backend: 'whatsapp-business-api', tables: 'FlowRegistry, FlowSubmission' },
  { path: '/workspace/whatsapp/flow-hub', label: 'WA Flow Hub', backend: 'whatsapp-business-api', tables: 'FlowRegistry, FlowSubmission, FlowLog' },
  { path: '/workspace/whatsapp/flow-responses', label: 'WA Flow Responses', backend: 'inbound-whatsapp-handler', tables: 'FlowSubmission, FlowLog, SubmitRequest' },
  { path: '/workspace/whatsapp/calling', label: 'WA Calling', backend: 'whatsapp-calling', tables: 'WhatsAppCalling' },
  { path: '/workspace/whatsapp/groups', label: 'WA Groups', backend: 'waba-management', tables: 'WhatsAppGroup' },
  { path: '/workspace/whatsapp/interactive-lists', label: 'WA Interactive Lists', backend: 'outbound-whatsapp', tables: '-' },
  { path: '/workspace/whatsapp/scripts', label: 'WA Scripts', backend: 'outbound-whatsapp', tables: '-' },
  { path: '/workspace/whatsapp/welcome', label: 'WA Welcome', backend: 'outbound-whatsapp', tables: 'Contact' },
  { path: '/workspace/whatsapp/auto-response', label: 'WA Auto Response', backend: 'ai-generate-response, ai-config-management', tables: 'ConversationHistory, SystemConfig' },
  { path: '/workspace/whatsapp/ai-config', label: 'WA AI Config', backend: 'ai-config-management', tables: 'SystemConfig' },
  { path: '/workspace/whatsapp/waba-dashboard', label: 'WABA Dashboard', backend: 'waba-management, meta-analytics', tables: 'MetaAnalyticsLog' },
  { path: '/workspace/whatsapp/business-profile', label: 'WA Business Profile', backend: 'whatsapp-business-api', tables: '-' },
  { path: '/workspace/whatsapp/webhooks', label: 'WA Webhooks', backend: 'inbound-whatsapp-handler', tables: 'WebhookDedup, SystemEvent' },
  { path: '/workspace/whatsapp/migration', label: 'WA Migration', backend: 'waba-management', tables: '-' },
  { path: '/workspace/logs', label: 'Message Logs (all channels)', backend: 'messages-read', tables: 'MessagesTable' },
  { path: '/workspace/whatsapp/settings', label: 'WA Settings', backend: 'waba-management', tables: 'SystemConfig' },
  // SMS
  { path: '/workspace/sms', label: 'SMS', backend: 'outbound-sms, sms-aws', tables: 'SmsAws, DLTTemplates, AirtelSMS (read-only history)' },
  // Voice
  { path: '/workspace/voice', label: 'Voice Out', backend: 'outbound-voice, voice-aws', tables: 'VoiceCall, VoiceAws' },
  { path: '/workspace/voice-in', label: 'Voice In', backend: 'voice-in, voice-cdr-read', tables: 'AirtelC2C, VoiceCDR, OBDCampaign' },
  // Email / RCS / Push
  { path: '/workspace/ses', label: 'Email', backend: 'outbound-email', tables: '-' },
  { path: '/workspace/rcs', label: 'RCS', backend: '(planned)', tables: '-' },
  { path: '/workspace/push', label: 'Push', backend: 'push-notifications', tables: '-' },
  { path: '/workspace/logs', label: 'Message Logs', backend: 'messages-read', tables: 'WhatsAppInbound, WhatsAppOutbound, SmsAws' },
  // Pay
  ...
  { path: '/workspace/faq', label: 'FAQ', backend: 'faq-handler', tables: 'SystemConfig' },
...
const CODE_MAP: CodeFolder[] = [
  ...
  { path: 'src/pages/workspace/whatsapp/', purpose: 'WhatsApp messaging pages (21 sub-pages)', files: '21 pages', linkedTo: '/workspace/whatsapp/*' },
  { path: 'src/pages/workspace/', purpose: 'Multi-channel messaging (SMS, Voice, Email, RCS, Push)', files: '~15 pages', linkedTo: '/workspace/*' },
...
const CODE_ASSETS: CodeAsset[] = [
  ...
  { id: 'ss-faq', category: 'Selfservice Flows', name: '❓ FAQ', description: 'View frequently asked questions.', path: '/workspace/faq', type: 'Page Link', status: 'Active' },
  // Frontend Pages
  ...
  { id: 'p-wa-inbox', category: 'Frontend Pages', name: 'WhatsApp Inbox', description: 'Real-time WhatsApp message inbox with contact sidebar.', path: 'src/pages/workspace/whatsapp/index.tsx', type: 'Page' },
  { id: 'p-wa-templates', category: 'Frontend Pages', name: 'WhatsApp Templates', description: 'Template management — create, edit, send, analytics.', path: 'src/pages/workspace/whatsapp/templates.tsx', type: 'Page' },
  { id: 'p-wa-flows', category: 'Frontend Pages', name: 'WhatsApp Flows', description: 'Flow builder and management for WhatsApp Business Flows.', path: 'src/pages/workspace/whatsapp/flows.tsx', type: 'Page' },
  { id: 'p-wa-flowhub', category: 'Frontend Pages', name: 'Flow Hub', description: 'Centralized flow registry, submissions, and analytics.', path: 'src/pages/workspace/whatsapp/flow-hub.tsx', type: 'Page' },
  { id: 'p-wa-calling', category: 'Frontend Pages', name: 'WhatsApp Calling', description: 'Voice/video call logs and WebRTC integration.', path: 'src/pages/workspace/whatsapp/calling.tsx', type: 'Page' },
  { id: 'p-wa-groups', category: 'Frontend Pages', name: 'WhatsApp Groups', description: 'Group management — create, participants, messaging.', path: 'src/pages/workspace/whatsapp/groups.tsx', type: 'Page' },
