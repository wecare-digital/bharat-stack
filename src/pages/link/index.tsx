/**
 * Link Page with Tabs (Create | Logs)
...
// Dynamic imports
const LinkCreate = dynamic(() => import('./create/index'), { ssr: false });
const LinkLogs = dynamic(() => import('./logs/index'), { ssr: false });
    ...
    <Layout user={user} onSignOut={signOut}>
      ...
      <div className="tabbed-page">
        ...
        <div className="tab-content">
          {activeTab === 'create' && <LinkCreate signOut={signOut} user={user} />}
          {activeTab === 'logs' && <LinkLogs signOut={signOut} user={user} />}
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .tab-content { flex: 1; overflow: auto; width: 100%; }
