  ...
  return (
    <>
      ...
      <main className="article-shell">
        <article>
          ...
          <div className="byline">
            <span>{ post.authorName || 'WECARE.DIGITAL' }</span>
          ...
          { post.coverImage && <img className="cover" src={ post.coverImage } alt="" /> }
      ...
      <style jsx>{`
        ...
        h1{font-size:clamp(40px,6vw,68px);line-height:1.02;letter-spacing:-.045em;color:#1a3a2a;margin:0 0 18px}
        .byline{display:flex;gap:14px;flex-wrap:wrap;font-size:12px;color:#6b7280;margin-bottom:32px}
        .cover{width:100%;border-radius:20px;display:block;margin:0 0 34px}
        .dek{font-size:20px;line-height:1.65;color:#4b5563;margin:0 0 34px}
        .content{font-family:Georgia,'Times New Roman',serif}
        .content p{font-size:18px;line-height:1.85;margin:0 0 24px;color:#27272a}
        .content h2{font-family:Inter,system-ui,sans-serif;font-size:30px;line-height:1.2;color:#1a3a2a;margin:46px 0 18px}
        .content h3{font-family:Inter,system-ui,sans-serif;font-size:23px;line-height:1.3;color:#1a3a2a;margin:36px 0 14px}
        ...
        @media(max-width:640px){.article-shell{padding:124px 16px 64px}.dek{font-size:18px}.content p{font-size:17px}}
      `}</style>
    </>
  );
}
