/**
 * Studio Page - Public landing page
...
const features = [
  { title: 'Visual Workflow Builder', desc: 'Drag-and-drop automations for WhatsApp, SMS, Email and Voice — no code required' },
  { title: 'AI-Powered Triggers', desc: 'Set up intelligent triggers based on customer behavior, keywords and payment events' },
  { title: 'Live Dashboards', desc: 'Real-time analytics and reporting that update as your workflows run' },
  { title: 'One-Click Integrations', desc: 'Connect Razorpay, Wix, Google Sheets, Shopify and 100+ apps instantly' },
  { title: 'Template Studio', desc: 'Design WhatsApp templates with rich media, buttons and carousels visually' },
  { title: 'Instant Deploy', desc: 'Go live in seconds — no build steps, no servers, no DevOps' },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Studio | WECARE.DIGITAL" />
        <meta property="og:description" content="Build powerful WhatsApp automations without writing code." />
        <meta property="og:image" content={LOGO_URL} />
        <meta property="og:url" content="https://stack.wecare.digital/studio" />
