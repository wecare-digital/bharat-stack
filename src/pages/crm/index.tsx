  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://stack.wecare.digital/crm" />
        ...
        <meta name="twitter:url" content="https://stack.wecare.digital/crm" />
        ...
        <link rel="canonical" href="https://stack.wecare.digital/crm" />
      ...
      <div className="page">
        <header className="hdr">
          <div className="hdr-in">
            <div className="logo">
              <img src="https://app.wecare.digital/stream/media/m/wecaredigital.png" alt="Stack CRM" className="logo-img" />
              <div className="logo-text"><span className="logo-main">Stack CRM</span><a href="https://www.wecare.digital" className="logo-sub" target="_blank" rel="noopener noreferrer">by WECARE.DIGITAL</a></div>
            </div>
          </div>
        </header>
