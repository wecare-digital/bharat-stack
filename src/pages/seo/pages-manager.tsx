...
function AuditDetail({ audit, audits, onSelect, onAction }: { audit: PageAudit | null; audits: PageAudit[]; onSelect: (a: PageAudit) => void; onAction: (id: string, action: string) => void }) {
  ...
  return (<div>
    ...
    <div className="card" style={{ padding: 16, marginBottom: 16 }}>
      <h3 style={{ fontSize: 13, fontWeight: 600, marginBottom: 8 }}>🏷️ Meta Tags (pushed to Wix on Apply)</h3>
...
After publishing: go to Blog SEO Manager > Clean+Audit for SEO`}</pre>
    </div>
  </div>);
}
