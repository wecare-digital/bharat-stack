...
FAQ_DATABASE = [
    ...
    {"keywords": ["convenience fee", "extra charge", "additional fee", "why charge"], "question": "What is the convenience fee?", "answer": "A 2% convenience fee is charged on the cart total, plus 18% GST on that fee. This covers payment gateway and processing costs. Total fee = (Cart × 2%) × 1.18"},
    ...
    {"keywords": ["app", "mobile", "android", "ios", "download", "install"], "question": "Is there a mobile app?", "answer": "Yes! Bharat Stack is available as a PWA. Visit stack.wecare.digital on mobile and tap 'Add to Home Screen'. Native iOS and Android apps are coming soon."},
