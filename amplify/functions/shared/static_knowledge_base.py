...
FAQ_DATABASE = [
    ...
    {"keywords": ["app", "mobile", "android", "ios", "download", "install"], "question": "Is there a mobile app?", "answer": "Yes! Bharat Stack is available as a PWA. Visit wecare.digital on mobile and tap 'Add to Home Screen'. Native iOS and Android apps are coming soon."},
