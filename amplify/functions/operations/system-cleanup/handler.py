...
CLEANUP_RESOURCES = {
    ...
    's3_whatsapp_voice': {
        ...
        'category': 'S3 Storage',
        'type': 's3',
        'prefix': 'base/whatsapp-media/voice/',
    },
    ...
    's3_whatsapp_media_incoming': {
        ...
        'category': 'S3 Storage',
        'type': 's3',
        'prefix': 'base/whatsapp-media/incoming/',
    },
    's3_whatsapp_media_outgoing': {
        'label': 'S3: WhatsApp Media (Outgoing)',
        'category': 'S3 Storage',
        'type': 's3',
        'prefix': 'base/whatsapp-media/outgoing/',
    },
    's3_template_headers': {
        'label': 'S3: Template Headers',
        'category': 'S3 Storage',
        'type': 's3',
        'prefix': 'base/whatsapp-media/template-headers/',
    },
    's3_product_images': {
        'label': 'S3: Product Images',
        'category': 'S3 Storage',
        'type': 's3',
        'prefix': 'base/store/products/',
    },
    's3_reports': {
    ...
    's3_whatsapp_calling_ai': {
        ...
        'category': 'S3 Storage',
        'type': 's3',
        'prefix': 'base/whatsapp-media/calling-ai/',
    },
    's3_whatsapp_downloads': {
        'label': 'S3: WhatsApp Media Downloads',
        'category': 'S3 Storage',
        'type': 's3',
        'prefix': 'base/whatsapp-media/downloads/',
    },
    # SQS Queues
    'sqs_inbound_dlq': {
