@echo off
echo === wecare-ai-generate-response ===
aws lambda get-function-configuration --function-name wecare-ai-generate-response --query Environment.Variables --output json --region us-east-1 --no-cli-pager
...
echo === wecare-agent-action-group ===
aws lambda get-function-configuration --function-name wecare-agent-action-group --query Environment.Variables --output json --region us-east-1 --no-cli-pager
