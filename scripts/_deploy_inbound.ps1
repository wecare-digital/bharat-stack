...
$FuncName = "wecare-inbound-whatsapp"
$HandlerPath = "amplify\functions\messaging\inbound-whatsapp-handler\handler.py"
$ModulesDir = "amplify\functions\messaging\inbound-whatsapp-handler\modules"
