...
UNDECLARED_ALLOWED: dict[str, str] = {
    ...
    "ShortLinksTable": "Provisioned by amplify/link-resources.ts for r.wecare.digital.",
    "LinkClicksTable": "Provisioned by amplify/link-resources.ts for r.wecare.digital.",
