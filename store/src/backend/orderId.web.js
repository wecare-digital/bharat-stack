 ...
 *
 * Generates custom order numbers with WDSR prefix (WECARE.DIGITAL Store Receipt).
 * Called from frontend, events, or automations to assign a human-readable order ID.
 *
 * Format: WDSR-YYYYMMDD-XXXX (e.g. WDSR-20260222-0042)
 *
 * The prefix is configurable — change PREFIX constant to rebrand.
 * Examples:
 *   WDSR-20260222-0042  (default — WECARE.DIGITAL Store Receipt)
...
/**
 * Build a WDSR-YYYYMMDD-XXXX order number for a given sequence.
 */
